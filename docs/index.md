...
- [Recursive Feature Elimination with Cross Validation using Permutation Importance](https://claudiosalvatorearcidiacono.github.io/felimination/reference/selectors/RFE/#felimination.rfe.PermutationImportanceRFECV)
- [Forward Feature Selection with Minimum Redundancy Maximum Relevance (MRMR)](https://claudiosalvatorearcidiacono.github.io/felimination/reference/selectors/MRMR/#felimination.mrmr.MRMRCV)
- [Hybrid Genetic Algorithms x Feature Importance selection](https://claudiosalvatorearcidiacono.github.io/felimination/reference/selectors/genetic_algorithms/#felimination.ga.HybridImportanceGACVFeatureSelector)
...
![MRMRCV fit plot](./assets/mrmrcv_fit_plot.png)
